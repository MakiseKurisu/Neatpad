...
{
    { RGB(255, 255, 255), TEXT("Automatic") },
    { RGB(0, 0, 0), TEXT("Black") },
    { RGB(255, 255, 255), TEXT("White") },
    { RGB(128, 0, 0), TEXT("Maroon") },
    { RGB(0, 128, 0), TEXT("Dark Green") },
    { RGB(128, 128, 0), TEXT("Olive") },
    { RGB(0, 0, 128), TEXT("Dark Blue") },
    { RGB(128, 0, 128), TEXT("Purple") },
    { RGB(0, 128, 128), TEXT("Aquamarine") },
    { RGB(196, 196, 196), TEXT("Light Grey") },
    { RGB(128, 128, 128), TEXT("Dark Grey") },
...
DWORD AddComboStringWithData(HWND hwnd, UINT uCtrl, LPTSTR szText, DWORD data)
{
...
int CALLBACK EnumFontNames(ENUMLOGFONTEX *lpelfe, NEWTEXTMETRICEX *lpntme, DWORD FontType, LPARAM lParam)
{
    ...
    LPTSTR pszName = lpelfe->elfLogFont.lfFaceName;
...
int CALLBACK EnumFontSizes(ENUMLOGFONTEX *lpelfe, NEWTEXTMETRICEX *lpntme, DWORD FontType, LPARAM lParam)
{
    ...
    if (fTrueType)
    {
        ...
        {
            _stprintf(ach, TEXT("%d"), ttsizes[i]);
...
VOID SelectColorInList(HWND hwnd, UINT uComboIdx, short itemIdx)
{
    ...
    else
    {
        ...
        {
            i = SendMessage(hwndCombo, CB_ADDSTRING, 0, (LONG) TEXT("Custom"));
...
BOOL InitFontOptionsDlg(HWND hwnd)
{
    ...
    AddColourListItem(hwnd, IDC_LIST1, TXC_FOREGROUND, TXC_BACKGROUND, TEXT("Text"));
    AddColourListItem(hwnd, IDC_LIST1, TXC_HIGHLIGHTTEXT, TXC_HIGHLIGHT, TEXT("Selected Text"));
    AddColourListItem(hwnd, IDC_LIST1, TXC_HIGHLIGHTTEXT2, TXC_HIGHLIGHT2, TEXT("Inactive Selection"));
    AddColourListItem(hwnd, IDC_LIST1, TXC_SELMARGIN1, TXC_SELMARGIN2, TEXT("Left Margin"));
    AddColourListItem(hwnd, IDC_LIST1, TXC_LINENUMBERTEXT, TXC_LINENUMBER, TEXT("Line Numbers"));
    AddColourListItem(hwnd, IDC_LIST1, -1, TXC_LONGLINE, TEXT("Long Lines"));
    AddColourListItem(hwnd, IDC_LIST1, TXC_CURRENTLINETEXT, TXC_CURRENTLINE, TEXT("Current Line"));
    ...
    //    Select
    //
    _stprintf(ach, TEXT("%d"), g_nFontSize);
    ...
    if ((g_fPaddingFlags & COURIERNEW) && lstrcmpi(g_szFontName, TEXT("Courier New")) == 0)
    {
        SetDlgItemInt(hwnd, IDC_PADDINGA, g_nPaddingAbove, 0);
        SetDlgItemInt(hwnd, IDC_PADDINGB, g_nPaddingBelow, 1);
    }

    if ((g_fPaddingFlags & LUCIDACONS) && lstrcmpi(g_szFontName, TEXT("Lucida Console")) == 0)
    {
...
BOOL CALLBACK AdvancedDlgProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_INITDIALOG:
        ...
        AddComboStringWithData(hwnd, IDC_COMBO1, TEXT("None"), NONANTIALIASED_QUALITY);
        AddComboStringWithData(hwnd, IDC_COMBO1, TEXT("Default"), DEFAULT_QUALITY);
        AddComboStringWithData(hwnd, IDC_COMBO1, TEXT("Antialiased"), ANTIALIASED_QUALITY);
        AddComboStringWithData(hwnd, IDC_COMBO1, TEXT("ClearType"), CLEARTYPE_QUALITY);
